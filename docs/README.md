...
- 사용자게 메뉴와 메뉴개수를 입력받는다.

- 사용자가 주문한 메뉴를 출력한다.

- 사용자가 주문한 메뉴의 총 주문금액을 출력한다.

- 주문날짜와 주문정보를 기반으로 이벤트 혜택을 출력한다.
